...
input double ProfitLock_Tier2_Mult        = 0.3;  // Trail multiplier once Tier 2 is reached (tightest)
...
int OnInit()
{
   ...
   Print("[INIT] ZX PP M5 v1 - progressive profit-lock + continuation re-entry edition (fixed 0.27 lot)");
...
// TP_Mode-based TP. Momentum trades (isMeanRev=false, the default) use
// Fixed_SL_Points for SL and TP_Mode (V3-A, see input block) for TP -
// nothing about the mean-reversion branch above changed.
