...
input double ManualTrade_CloseProfitUSD = 24.0;  // Auto-close a detected manual trade once its floating profit reaches this many dollars
input double ManualTrade_CloseLossUSD   = 42.0;  // G-1: Auto-close a detected manual trade once its floating LOSS reaches this many dollars (strict per-trade stop loss)
...
int OnInit()
{
   ...
   Print("[INIT] ZX_PP_Guardian_v1 - manual-trade stop-loss + basket take-profit edition");
