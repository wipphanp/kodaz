//+------------------------------------------------------------------+
//|                             ea_5minCandle_scalp_v6_Fixed18SL.mq5 |
...
//=== SL/TP SETTINGS ===
input double Fixed_SL_Points = 18; // Always fixed 18 points from entry
...
//+------------------------------------------------------------------+
// Hardcoded dollar TP removed. Only ATR-based dynamic runtime TP remains.
