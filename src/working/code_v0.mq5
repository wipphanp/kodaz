...
input int Scalp_AI_RefreshSeconds = 60;
...
int OnInit()
{
   ...
   // Scalp-specific indicators (M1/M5) - always initialized since scalp is active mode
...
void OnTick()
{
   ...
   // Route to scalp mode only (swing mode commented out)
...
/*==================================================
// SWING MODE - AI decides every trade (COMMENTED OUT)
//==================================================
void OnTick_Swing()
{
...
/*--------------------------------------------------
// SWING TRADE FUNCTIONS (COMMENTED OUT)
void OpenSwingBuy()
{
   double ask = SymbolInfoDouble(_Symbol, SYMBOL_ASK);
...
string OpenAIRequest(string prompt)
{
   ...
   // Scalp mode context (swing mode commented out)
   string modeContext = "You provide DIRECTIONAL BIAS for a scalping system using EMA9/21 on M1. "
                    "The scalper only takes trades in YOUR direction.\\n";
   // string modeContext = "You provide direct trade signals for a swing trading system on H1.\\n";
